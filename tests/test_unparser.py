...
EXPLICIT_TYPES = [
    ...
    (UUID("12345678-1234-1234-1234-123456789abc"), "uuid:12345678123412341234123456789abc",),
    (date(2020, 11, 21), "date:2020-11-21"),
    (datetime(2020, 11, 21, 10, 0, 0), "datetime:2020-11-21T10:00:00"),
    (datetime(2020, 11, 21, 10, 0, 0, tzinfo=timezone.utc), "datetime:2020-11-21T10:00:00+00:00",),
]
